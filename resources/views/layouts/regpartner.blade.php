      ...
      <div class="modal-body">
        ...
        <div class="form-group text-right">
          ...
          <div class="business_number-group form-group">
            <label for="business_number" class="col-sm-3 control-label">Business Number:</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" id="business_number" placeholder="Enter your Business Number" name="business_number">
            </div>
            <p class="col-sm-offset-2 col-sm-10 help-block"></p>
          </div>
          <div class="office_location-country-group office_location-state-group office_location-city-group office_location-street-group office_location-suite-group office_location-postalcode-group form-group office_location">
            <label for="office_location" class="col-md-3 control-label">Office Location:</label>
            <div class="col-md-3">
                        <select name="office_location[0][country]" class="office_location.country form-control countries" required="required">
            ...
            <div class="col-md-3">
              <select name="office_location[0][state]" class="form-control states" required="required">
                <option value="">Select State/Province</option>
              </select>
            </div>
            <div class="col-md-3">
              <select name="office_location[0][city]" class="form-control cities" required="required">
                <option value="">Select City</option>
              </select>
            </div>
            <div class="col-lg-3 col-lg-offset-3">
                  <input id="office_location_street" type="text" class="form-control" name="office_location[0][street]" required placeholder="Street/Road/Ave Name">
              </div>
              <div class="col-lg-3">
              <input id="office_location_suite" type="text" class="form-control" name="office_location[0][suite]" required placeholder="Suite Number">
            </div>

            <div class="col-lg-3">
              <input id="office_location_postal" type="text" class="form-control" name="office_location[0][postalcode]" required placeholder="Postal Code">
            </div>
            <p class="col-sm-offset-2 col-sm-10 help-block"></p>
          </div>
          <div class="form-group branch_location">
            <label for="branch_location" class="col-md-3 control-label">Branch Location:</label>
            <div class="col-md-3">
          ...
          <div class="form-group">
            <label for="branch_manager" class="col-sm-3 control-label">Branch Manager:</label>
            <div class="col-sm-4">
          ...
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label">Office Telephone:</label>
            <div class="col-sm-2">
          ...
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label">Branch Manager's Cellphone:</label>
            <div class="col-sm-2">
          ...
          <div class="office_email-group form-group">
            <label for="office_email" class="col-sm-3 control-label">Office/Branch Email:</label>
            <div class="col-sm-3">
          ...
          <div class="form-group business_license_number-group">
            <label for="business_license_number" class="col-sm-3 control-label">Business License Number:</label>
            <div class="col-sm-6">
          ...
          <div class="form-group">
            <label for="scanned_business" class="col-sm-3 control-label">Scanned Business License for the Current Year:</label>
            <div class="col-sm-6">
          ...
          <div class="form-group">
            <label for="issued_documents" class="col-sm-3 control-label">Other Government-issued Documents:</label>
            <div class="col-sm-6">
          ...
          <div class="password_confirmation-group form-group">
            <label for="password_confirmation" class="col-sm-3 control-label">Repeat your password:</label>
            <div class="col-sm-4">
              <input type="password" class="form-control" placeholder="Type your password again" name="password_confirmation">
            </div>
            <p class="col-sm-offset-2 col-sm-10 help-block"></p>
          </div>
          <div class="form-group">
