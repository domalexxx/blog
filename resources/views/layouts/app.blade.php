...
?>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ url('/') }}/img/logo.png" width="200" height="71">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse text-center" id="app-navbar-collapse">
                ...
                <ul class="link nav navbar-nav">
                    <li>
                        <a class="modalRegPartner" data-toggle="modal" href="">
                            JOIN US / LOGIN <br> AS A SHIPPING PARTNER
                        </a>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a class="modalRegister" data-toggle="modal" href="">SIGN UP/LOGIN</a></li>
                    @else
                        <li class="dropdown">
    ...
    @include('layouts.regpartner')
    @include('layouts.logpartner')
    <!-- JavaScripts -->
